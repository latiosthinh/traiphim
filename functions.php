<?php
/**
 * traiphim functions and definitions
 *
...
if ( ! function_exists( 'traiphim_setup' ) ) :
	/**
	 ...
	 */
	function traiphim_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on traiphim, use a find and replace
		 * to change 'traiphim' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'traiphim', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'traiphim' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'traiphim_custom_background_args',
				array(
 ...
 */
function traiphim_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'traiphim_content_width', 640 );
}
add_action( 'after_setup_theme', 'traiphim_content_width', 0 );
 ...
 */
function traiphim_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'traiphim' ),
			'id'            => 'sidebar-1',
...
add_action( 'widgets_init', 'traiphim_widgets_init' );
